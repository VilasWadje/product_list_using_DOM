  ...
  for(i=0;i<productList.length;i++){
    if(productList[i].isAccessory==false){
      ...
      //image
        ...
        clothCard.classList.add("cloth");
        document.getElementById("clothing").appendChild(clothCard);

        var image=document.createElement("img");
        image.src=productList[i].preview;
        image.classList.add("image");
        clothCard.appendChild(image);
      ...
      //details
        ...
        var clothName=document.createElement("h3");
        clothName.innerHTML="Men Navy Blue Solid Sweatshirt";
        clothName.classList.add("clothName");
        details.appendChild(clothName);
        ...
        var clothCard=document.createElement("div");
        clothCard.classList.add("cloth");
        document.getElementById("accessories").appendChild(clothCard);
